...
SELECT COUNT(userId) AS total_records,(SELECT SUM(latitude) FROM `pinned_businesses`) as total_lat,(SELECT MAX(latitude) FROM `pinned_businesses`) as max_lat,(SELECT MIN(latitude) FROM `pinned_businesses`) as min_lat,(SELECT AVG(latitude) FROM `pinned_businesses`) as ave_lat FROM `pinned_businesses`;
